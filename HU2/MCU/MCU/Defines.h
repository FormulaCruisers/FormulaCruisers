...
#define SOFTWARE_VERSION			"Software: V2.108    "  //Version should be 2.xxx where xxx is amount of commits(do "git rev-list HEAD --count" to check)

#define RTDS						PC7 //Loud ready beep
#define RTDS_TIME					2000 //2 seconds //Has to be between 1 and 3 seconds!

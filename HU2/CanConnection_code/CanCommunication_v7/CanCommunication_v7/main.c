...
uint8_t RS232Buffer[40];
uint8_t RS232BufferCountRead = 11;
uint8_t RS232BufferCountWrite = 10;
uint8_t RS232BufferBuffer = 30;
...
int main( void )
{
	...
	while(1)
	{
		...
		*/
		...
		/*
		_delay_ms(100);
		while(RS232BufferCountRead != RS232BufferCountWrite){
			RS232BufferCountWrite = RS232BufferCountWrite * (RS232BufferCountWrite < RS232BufferBuffer) + 1;
			USARTWriteChar(RS232Buffer[RS232BufferCountWrite] & 0xFF);
		}
		*/
